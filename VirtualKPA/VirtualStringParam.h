 ...
 */
#ifndef VIRTUALSTRINGPARAM_H
#define VIRTUALSTRINGPARAM_H
#include "VirtualParam.h"

class VirtualStringParam : public VirtualParam {
public:
  VirtualStringParam(ParamId id, VirtualModule *module);

  FunctionCode getFunctionCode() override { return 3; }
  ...
  bool isTagParam() override { return mIsTagParam; }
