...
VirtualUnknownParam::VirtualUnknownParam(FunctionCode type, ParamId id,
                                         VirtualModule *module)
    : VirtualParam(id, module), mType(type) {}
...
ByteArray VirtualUnknownParam::createResponse(const ByteArray &,
                                              bool includeLen) {
