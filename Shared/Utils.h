...
class Utils {
public:
  static double raw2Phys(unsigned short rawVal, double deltaMinMax,
                         double min) {
    double physVal = ((rawVal * deltaMinMax) / 0x3FFF) + min;
    return physVal;
  }

  static bool raw2Bool(unsigned short rawVal) { return rawVal != 0; }

  static unsigned short phys2Raw(double physVal, double deltaMinMax, double min,
                                 unsigned short maxRawVal = 0x3FFF) {
