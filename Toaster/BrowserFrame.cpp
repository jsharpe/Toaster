...
BrowserFrame::BrowserFrame(QWidget *parent) : QFrame(parent) {
  ...
  connect(&profileObj, &Profile::rigNameReceived, this,
          &BrowserFrame::onRigName);
  connect(&profileObj, &Profile::rigAuthorReceived, this,
          &BrowserFrame::onRigAuthor);
  connect(&profileObj, &Profile::ampNameReceived, this,
          &BrowserFrame::onAmpName);
  // extended parameter
  connect(&extParamObj, &ExtParam::browserViewReceived, this,
          &BrowserFrame::onBrowserView);
}
