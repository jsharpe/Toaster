...
WahWahFrame::WahWahFrame(QWidget *parent) : QWidget(parent) {
  ui.setupUi(this);
}
...
void WahWahFrame::displayStompEnabled(StompInstance stompInstance,
                                      bool enabled) {
