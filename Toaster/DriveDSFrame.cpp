...
DriveDSFrame::DriveDSFrame(QWidget *parent) : QWidget(parent) {
  ui.setupUi(this);
...
void DriveDSFrame::displayStompType(StompInstance stompInstance,
                                    FXType fxType) {
  ui.lcdDisplay->setStompFXType(stompInstance, fxType);
}

void DriveDSFrame::displayStompEnabled(StompInstance stompInstance,
                                       bool enabled) {
