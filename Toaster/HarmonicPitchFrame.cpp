...
HarmonicPitchFrame::HarmonicPitchFrame(QWidget *parent) : QWidget(parent) {
  ui.setupUi(this);
...
void HarmonicPitchFrame::deactivate() {
  if (mpStomp != nullptr) {
    disconnect(mpStomp, &Stomp::voice1IntervalReceived, this,
               &HarmonicPitchFrame::onVoice1Interval);
    disconnect(mpStomp, &Stomp::voice2IntervalReceived, this,
               &HarmonicPitchFrame::onVoice2Interval);
...
void HarmonicPitchFrame::displayStompType(StompInstance stompInstance,
                                          FXType fxType) {
  ui.lcdDisplay->setStompFXType(stompInstance, fxType);
}

void HarmonicPitchFrame::displayStompEnabled(StompInstance stompInstance,
                                             bool enabled) {
