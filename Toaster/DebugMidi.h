...
public:
  ...
  void debugRequestStringParam(unsigned char addressPage,
                               unsigned char parameter, unsigned short val);

  void debugScanRequest(unsigned char adddressPage, unsigned char minParam,
  ...
  void debugSendSingleParam(const ByteArray &addressPage,
                            const ByteArray &param, const ByteArray &value);

  void debugSendStringParam(const ByteArray &addressPage,
                            const ByteArray &param, const ByteArray &value);

  void debugSendExtParam(unsigned int param, unsigned int value);

  void debugSendReserveFct7E(const ByteArray &addressPage,
                             const ByteArray &param, const ByteArray &value);

  void debugSendReserveFct7F(const ByteArray &addressPage,
                             const ByteArray &param, const ByteArray &value);
