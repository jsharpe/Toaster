...
StudioEqualizerFrame::StudioEqualizerFrame(QWidget *parent) : QWidget(parent) {
  ui.setupUi(this);
...
void StudioEqualizerFrame::activate(QObject &stomp) {
  ...
  if (mpStomp != nullptr) {
    ...
    connect(mpStomp, &Stomp::duckingReceived, this,
            &StudioEqualizerFrame::onDucking);
    connect(mpStomp, &Stomp::volumeReceived, this,
            &StudioEqualizerFrame::onVolume);
    connect(mpStomp, &Stomp::lowCutReceived, this,
            &StudioEqualizerFrame::onLowCut);
    connect(mpStomp, &Stomp::highCutReceived, this,
            &StudioEqualizerFrame::onHighCut);
    connect(mpStomp, &Stomp::parametricEQLowGainReceived, this,
            &StudioEqualizerFrame::onLowGain);
    connect(mpStomp, &Stomp::parametricEQLowFrequencyReceived, this,
            &StudioEqualizerFrame::onLowFreq);
    connect(mpStomp, &Stomp::parametricEQHighGainReceived, this,
            &StudioEqualizerFrame::onHighGain);
    connect(mpStomp, &Stomp::parametricEQHighFrequencyReceived, this,
            &StudioEqualizerFrame::onHighFreq);
    connect(mpStomp, &Stomp::parametricEQPeakGainReceived, this,
            &StudioEqualizerFrame::onMid1Gain);
    connect(mpStomp, &Stomp::parametricEQPeakFrequencyReceived, this,
            &StudioEqualizerFrame::onMid1Freq);
    connect(mpStomp, &Stomp::parametricEQPeakQFactorReceived, this,
            &StudioEqualizerFrame::onMid1QFactor);
    connect(mpStomp, &Stomp::parametricEQPeakGain2Received, this,
            &StudioEqualizerFrame::onMid2Gain);
    connect(mpStomp, &Stomp::parametricEQPeakFrequency2Received, this,
            &StudioEqualizerFrame::onMid2Freq);
    connect(mpStomp, &Stomp::parametricEQPeakQFactor2Received, this,
            &StudioEqualizerFrame::onMid2QFactor);
...
void StudioEqualizerFrame::deactivate() {
  if (mpStomp != nullptr) {
    disconnect(mpStomp, &Stomp::mixReceived, this,
               &StudioEqualizerFrame::onMix);
    ...
    disconnect(mpStomp, &Stomp::parametricEQLowGainReceived, this,
               &StudioEqualizerFrame::onLowGain);
    disconnect(mpStomp, &Stomp::parametricEQLowFrequencyReceived, this,
               &StudioEqualizerFrame::onLowFreq);
    disconnect(mpStomp, &Stomp::parametricEQHighGainReceived, this,
               &StudioEqualizerFrame::onHighGain);
    disconnect(mpStomp, &Stomp::parametricEQHighFrequencyReceived, this,
               &StudioEqualizerFrame::onHighFreq);
    ...
    disconnect(mpStomp, &Stomp::parametricEQPeakFrequencyReceived, this,
               &StudioEqualizerFrame::onMid1Freq);
    disconnect(mpStomp, &Stomp::parametricEQPeakQFactorReceived, this,
               &StudioEqualizerFrame::onMid1QFactor);
    disconnect(mpStomp, &Stomp::parametricEQPeakGain2Received, this,
               &StudioEqualizerFrame::onMid2Gain);
    disconnect(mpStomp, &Stomp::parametricEQPeakFrequency2Received, this,
               &StudioEqualizerFrame::onMid2Freq);
    disconnect(mpStomp, &Stomp::parametricEQPeakQFactor2Received, this,
               &StudioEqualizerFrame::onMid2QFactor);
    mpStomp = nullptr;
  }
}
...
void StudioEqualizerFrame::displayStompType(StompInstance stompInstance,
                                            FXType fxType) {
  ui.lcdDisplay->setStompFXType(stompInstance, fxType);
}

void StudioEqualizerFrame::displayStompEnabled(StompInstance stompInstance,
                                               bool enabled) {
