...
PedalPitchFrame::PedalPitchFrame(QWidget *parent) : QWidget(parent) {
  ui.setupUi(this);
...
void PedalPitchFrame::displayStompType(StompInstance stompInstance,
                                       FXType fxType) {
  ui.lcdDisplay->setStompFXType(stompInstance, fxType);
}

void PedalPitchFrame::displayStompEnabled(StompInstance stompInstance,
                                          bool enabled) {
