...
TapDelayFrame::TapDelayFrame(QWidget *parent) : QWidget(parent) {
  ui.setupUi(this);
}
...
void TapDelayFrame::activate(QObject &stomp) {
  ...
  if (mpDelay != nullptr) {
    connect(mpDelay, &Delay::bandwidthReceived, this,
            &TapDelayFrame::onBandwidth);
    connect(mpDelay, &Delay::centerFrequencyReceived, this,
            &TapDelayFrame::onCenterFrequency);
    connect(mpDelay, &Delay::modulationReceived, this,
            &TapDelayFrame::onModulation);
    connect(mpDelay, &Delay::duckingReceived, this, &TapDelayFrame::onDucking);
    connect(mpDelay, &Delay::clockLeftReceived, this,
            &TapDelayFrame::onClockLeft);
    connect(mpDelay, &Delay::clockRightReceived, this,
            &TapDelayFrame::onClockRight);
    ...
    ui.lcdDisplay->setStompName(
        LookUpTables::stompFXName(mpDelay->getDelayType()));
  }
}

void TapDelayFrame::deactivate() {
  if (mpDelay != nullptr) {
    disconnect(mpDelay, &Delay::bandwidthReceived, this,
               &TapDelayFrame::onBandwidth);
    disconnect(mpDelay, &Delay::centerFrequencyReceived, this,
               &TapDelayFrame::onCenterFrequency);
    disconnect(mpDelay, &Delay::modulationReceived, this,
               &TapDelayFrame::onModulation);
    disconnect(mpDelay, &Delay::duckingReceived, this,
               &TapDelayFrame::onDucking);
    disconnect(mpDelay, &Delay::clockLeftReceived, this,
               &TapDelayFrame::onClockLeft);
    disconnect(mpDelay, &Delay::clockRightReceived, this,
               &TapDelayFrame::onClockRight);
...
void TapDelayFrame::displayStompType(StompInstance stompInstance,
                                     FXType fxType) {
  ui.lcdDisplay->setStompFXType(stompInstance, fxType);
}

void TapDelayFrame::displayStompEnabled(StompInstance stompInstance,
                                        bool enabled) {
...
void TapDelayFrame::onDucking(double value) { ui.duckingDial->setValue(value); }
...
void TapDelayFrame::onVolume(double value) { ui.volumeDial->setValue(value); }
