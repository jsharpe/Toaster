...
RectiShaperFrame::RectiShaperFrame(QWidget *parent) : QWidget(parent) {
  ui.setupUi(this);
}
...
void RectiShaperFrame::displayStompType(StompInstance stompInstance,
                                        FXType fxType) {
  ui.lcdDisplay->setStompFXType(stompInstance, fxType);
}

void RectiShaperFrame::displayStompEnabled(StompInstance stompInstance,
                                           bool enabled) {
