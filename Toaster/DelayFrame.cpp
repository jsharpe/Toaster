...
DelayFrame::DelayFrame(QWidget *parent) : QWidget(parent) { ui.setupUi(this); }
...
void DelayFrame::activate(QObject &stomp) {
  ...
  if (mpDelay != nullptr) {
    ...
    connect(mpDelay, &Delay::centerFrequencyReceived, this,
            &DelayFrame::onCenterFrequency);
    connect(mpDelay, &Delay::modulationReceived, this,
            &DelayFrame::onModulation);
...
void DelayFrame::displayStompEnabled(StompInstance stompInstance,
                                     bool enabled) {
