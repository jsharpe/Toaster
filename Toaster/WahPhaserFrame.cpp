...
WahPhaserFrame::WahPhaserFrame(QWidget *parent) : QWidget(parent) {
  ui.setupUi(this);
}
...
void WahPhaserFrame::deactivate() {
  if (mpStomp != nullptr) {
    ...
    disconnect(mpStomp, &Stomp::wahRangeReceived, this,
               &WahPhaserFrame::onPedalRange);
    disconnect(mpStomp, &Stomp::wahPeakRangeReceived, this,
               &WahPhaserFrame::onPeakRange);
    ...
    disconnect(mpStomp, &Stomp::duckingReceived, this,
               &WahPhaserFrame::onDucking);
    disconnect(mpStomp, &Stomp::volumeReceived, this,
               &WahPhaserFrame::onVolume);
...
void WahPhaserFrame::displayStompType(StompInstance stompInstance,
                                      FXType fxType) {
  ui.lcdDisplay->setStompFXType(stompInstance, fxType);
}

void WahPhaserFrame::displayStompEnabled(StompInstance stompInstance,
                                         bool enabled) {
