...
PhaserFrame::PhaserFrame(QWidget *parent) : QWidget(parent) {
  ui.setupUi(this);
...
void PhaserFrame::deactivate() {
  if (mpStomp != nullptr) {
    disconnect(
        mpStomp,
        static_cast<void (Stomp::*)(int)>(&Stomp::modulationRateReceived), this,
        &PhaserFrame::onRate);
...
void PhaserFrame::displayStompEnabled(StompInstance stompInstance,
                                      bool enabled) {
