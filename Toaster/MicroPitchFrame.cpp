...
MicroPitchFrame::MicroPitchFrame(QWidget *parent) : QWidget(parent) {
...
void MicroPitchFrame::displayStompType(StompInstance stompInstance,
                                       FXType fxType) {
  ui.lcdDisplay->setStompFXType(stompInstance, fxType);
}

void MicroPitchFrame::displayStompEnabled(StompInstance stompInstance,
                                          bool enabled) {
