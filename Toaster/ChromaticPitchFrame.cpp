...
ChromaticPitchFrame::ChromaticPitchFrame(QWidget *parent) : QWidget(parent) {
  ui.setupUi(this);
...
void ChromaticPitchFrame::activate(QObject &stomp) {
  ...
  if (mpStomp != nullptr) {
    connect(mpStomp, &Stomp::voice1PitchReceived, this,
            &ChromaticPitchFrame::onVoice1Pitch);
    connect(mpStomp, &Stomp::voice2PitchReceived, this,
            &ChromaticPitchFrame::onVoice2Pitch);
    connect(mpStomp, &Stomp::formantShiftReceived, this,
            &ChromaticPitchFrame::onFormantShift);
    connect(mpStomp, &Stomp::detuneReceived, this,
            &ChromaticPitchFrame::onDetune);
    connect(mpStomp, &Stomp::voiceMixReceived, this,
            &ChromaticPitchFrame::onVoiceMix);
    connect(mpStomp, &Stomp::intensityReceived, this,
            &ChromaticPitchFrame::onMix);
    connect(mpStomp, &Stomp::duckingReceived, this,
            &ChromaticPitchFrame::onDucking);
    connect(mpStomp, &Stomp::volumeReceived, this,
            &ChromaticPitchFrame::onVolume);
    connect(mpStomp, &Stomp::smoothChordsReceived, this,
            &ChromaticPitchFrame::onSmoothChords);
    connect(mpStomp, &Stomp::pureTuningReceived, this,
            &ChromaticPitchFrame::onPureTuning);
    connect(mpStomp, &Stomp::formantShiftOnOffReceived, this,
            &ChromaticPitchFrame::onFormantShiftOnOff);
    connect(mpStomp, &Stomp::stereoReceived, this,
            &ChromaticPitchFrame::onStereo);
...
void ChromaticPitchFrame::deactivate() {
  if (mpStomp != nullptr) {
    disconnect(mpStomp, &Stomp::voice1PitchReceived, this,
               &ChromaticPitchFrame::onVoice1Pitch);
    disconnect(mpStomp, &Stomp::voice2PitchReceived, this,
               &ChromaticPitchFrame::onVoice2Pitch);
    disconnect(mpStomp, &Stomp::formantShiftReceived, this,
               &ChromaticPitchFrame::onFormantShift);
    disconnect(mpStomp, &Stomp::detuneReceived, this,
               &ChromaticPitchFrame::onDetune);
    disconnect(mpStomp, &Stomp::voiceMixReceived, this,
               &ChromaticPitchFrame::onVoiceMix);
    ...
    disconnect(mpStomp, &Stomp::volumeReceived, this,
               &ChromaticPitchFrame::onVolume);
    disconnect(mpStomp, &Stomp::smoothChordsReceived, this,
               &ChromaticPitchFrame::onSmoothChords);
    disconnect(mpStomp, &Stomp::pureTuningReceived, this,
               &ChromaticPitchFrame::onPureTuning);
    disconnect(mpStomp, &Stomp::formantShiftOnOffReceived, this,
               &ChromaticPitchFrame::onFormantShiftOnOff);
...
void ChromaticPitchFrame::displayStompType(StompInstance stompInstance,
                                           FXType fxType) {
  ui.lcdDisplay->setStompFXType(stompInstance, fxType);
}

void ChromaticPitchFrame::displayStompEnabled(StompInstance stompInstance,
                                              bool enabled) {
...
void ChromaticPitchFrame::on_formantShiftOnOffDial_valueChanged(
    int valueIndex) {
  if (mpStomp != nullptr)
