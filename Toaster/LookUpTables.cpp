...
QMap<StompInstance, QString> LookUpTables::sStompInstanceNames = {
    {StompA, "Stomp A"},         {StompB, "Stomp B"},
    {StompC, "Stomp C"},         {StompD, "Stomp D"},
...
QMap<FXType, QString> LookUpTables::sStompFXNames = {
    {None, "None"},
    {WahWah, "Wah Wah"},
    ...
    {Space, "Space"},
    {LegacyDelay, "Legacy Delay"},
    {SingleDelay, "Single Delay"},
    {DualDelay, "Dual Delay"},
    {TwoTapDelay, "TwoTap Delay"},
    {SerialTwoTapDelay, "Serial TwoTap Delay"},
    {RhythmDelay, "Rhythm Delay"},
    {QuadDelay, "Quad Delay"},
    {CrystalDelay, "Crystal Delay"},
    {LoopPitchDelay, "Loop Pitch Delay"},
    {FrequencyShifterDelay, "Freq Shifter Delay"},
    {DualChromaticDelay, "Dual Chromatic"},
    {DualHarmonicDelay, "Dual Harmonic"},
    {DualCrystalDelay, "Dual Crystal"},
    {DualLoopPitchDelay, "Dual Loop Pitch"},
    {MelodyDelay, "Melody Chromatic"},
    {QuadChromaticDelay, "Quad Chromatic"},
    {QuadHarmonicDelay, "Quad Harmonic"},
    {DualCrystal, "Dual Crystal"},
    {Transpose, "Transpose"},
...
QVector<QString> LookUpTables::sNotes = {"C",  "C#", "D",  "D#", "E",  "F",
                                         "F#", "G",  "G#", "A",  "A#", "B"};
