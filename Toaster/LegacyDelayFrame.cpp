...
LegacyDelayFrame::LegacyDelayFrame(QWidget *parent) : QWidget(parent) {
  ui.setupUi(this);
...
void LegacyDelayFrame::activate(QObject &stomp) {
  ...
  if (mpStomp != nullptr) {
    ...
    connect(mpStomp, &Stomp::delay1TimeReceived, this,
            &LegacyDelayFrame::OnDelay1Time);
    connect(mpStomp, &Stomp::delay2RatioReceived, this,
            &LegacyDelayFrame::OnDelay2Ratio);
    connect(mpStomp, &Stomp::delayFeedbackReceived, this,
            &LegacyDelayFrame::OnFeedback);
    connect(mpStomp, &Stomp::delayNoteValue1Received, this,
            &LegacyDelayFrame::OnNoteValue1);
    connect(mpStomp, &Stomp::delayNoteValue2Received, this,
            &LegacyDelayFrame::OnNoteValue2);
    connect(mpStomp, &Stomp::delayToTempoReceived, this,
            &LegacyDelayFrame::OnToTempo);
    connect(mpStomp, &Stomp::distortionShaperDriveReceived, this,
            &LegacyDelayFrame::OnBandwidth);
    connect(mpStomp, &Stomp::distortionBoosterToneReceived, this,
            &LegacyDelayFrame::OnFrequency);
    connect(mpStomp, &Stomp::delayModulationReceived, this,
            &LegacyDelayFrame::OnModulation);
    connect(mpStomp, &Stomp::duckingReceived, this,
            &LegacyDelayFrame::OnDucking);
...
void LegacyDelayFrame::deactivate() {
  if (mpStomp != nullptr) {
    disconnect(mpStomp, &Stomp::delayMixReceived, this,
               &LegacyDelayFrame::OnMix);
    disconnect(mpStomp, &Stomp::delay1TimeReceived, this,
               &LegacyDelayFrame::OnDelay1Time);
    disconnect(mpStomp, &Stomp::delay2RatioReceived, this,
               &LegacyDelayFrame::OnDelay2Ratio);
    disconnect(mpStomp, &Stomp::delayFeedbackReceived, this,
               &LegacyDelayFrame::OnFeedback);
    disconnect(mpStomp, &Stomp::delayNoteValue1Received, this,
               &LegacyDelayFrame::OnNoteValue1);
    disconnect(mpStomp, &Stomp::delayNoteValue2Received, this,
               &LegacyDelayFrame::OnNoteValue2);
    disconnect(mpStomp, &Stomp::delayToTempoReceived, this,
               &LegacyDelayFrame::OnToTempo);
    disconnect(mpStomp, &Stomp::distortionShaperDriveReceived, this,
               &LegacyDelayFrame::OnBandwidth);
    disconnect(mpStomp, &Stomp::distortionBoosterToneReceived, this,
               &LegacyDelayFrame::OnFrequency);
    disconnect(mpStomp, &Stomp::delayModulationReceived, this,
               &LegacyDelayFrame::OnModulation);
...
void LegacyDelayFrame::displayStompType(StompInstance stompInstance,
                                        FXType fxType) {
  ui.lcdDisplay->setStompFXType(stompInstance, fxType);
}

void LegacyDelayFrame::displayStompEnabled(StompInstance stompInstance,
                                           bool enabled) {
