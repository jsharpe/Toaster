...
VibratoFrame::VibratoFrame(QWidget *parent) : QWidget(parent) {
  ui.setupUi(this);
...
void VibratoFrame::displayStompType(StompInstance stompInstance,
                                    FXType fxType) {
  ui.lcdDisplay->setStompFXType(stompInstance, fxType);
}

void VibratoFrame::displayStompEnabled(StompInstance stompInstance,
                                       bool enabled) {
