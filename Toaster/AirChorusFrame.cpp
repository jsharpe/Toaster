...
AirChorusFrame::AirChorusFrame(QWidget *parent) : QWidget(parent) {
  ui.setupUi(this);
...
void AirChorusFrame::displayStompType(StompInstance stompInstance,
                                      FXType fxType) {
  ui.lcdDisplay->setStompFXType(stompInstance, fxType);
}

void AirChorusFrame::displayStompEnabled(StompInstance stompInstance,
                                         bool enabled) {
