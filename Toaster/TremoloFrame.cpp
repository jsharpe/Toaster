...
TremoloFrame::TremoloFrame(QWidget *parent) : QWidget(parent) {
  ui.setupUi(this);
...
void TremoloFrame::displayStompType(StompInstance stompInstance,
                                    FXType fxType) {
  ui.lcdDisplay->setStompFXType(stompInstance, fxType);
}

void TremoloFrame::displayStompEnabled(StompInstance stompInstance,
                                       bool enabled) {
