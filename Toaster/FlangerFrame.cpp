...
FlangerFrame::FlangerFrame(QWidget *parent) : QWidget(parent) {
  ui.setupUi(this);
...
void FlangerFrame::displayStompType(StompInstance stompInstance,
                                    FXType fxType) {
  ui.lcdDisplay->setStompFXType(stompInstance, fxType);
}

void FlangerFrame::displayStompEnabled(StompInstance stompInstance,
                                       bool enabled) {
