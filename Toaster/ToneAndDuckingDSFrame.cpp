...
void ToneAndDuckingDSFrame::displayStompType(StompInstance stompInstance,
                                             FXType fxType) {
  ui.lcdDisplay->setStompFXType(stompInstance, fxType);
}

void ToneAndDuckingDSFrame::displayStompEnabled(StompInstance stompInstance,
                                                bool enabled) {
