...
FlangerOnewayFrame::FlangerOnewayFrame(QWidget *parent) : QWidget(parent) {
  ui.setupUi(this);
}
...
void FlangerOnewayFrame::displayStompType(StompInstance stompInstance,
                                          FXType fxType) {
  ui.lcdDisplay->setStompFXType(stompInstance, fxType);
}

void FlangerOnewayFrame::displayStompEnabled(StompInstance stompInstance,
                                             bool enabled) {
