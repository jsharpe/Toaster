...
WahFormantShiftFrame::WahFormantShiftFrame(QWidget *parent) : QWidget(parent) {
  ui.setupUi(this);
}
...
void WahFormantShiftFrame::displayStompType(StompInstance stompInstance,
                                            FXType fxType) {
  ui.lcdDisplay->setStompFXType(stompInstance, fxType);
}

void WahFormantShiftFrame::displayStompEnabled(StompInstance stompInstance,
                                               bool enabled) {
