...
TunerFrame::TunerFrame(QWidget *parent) : QWidget(parent) {
  ui.setupUi(this);
  connect(&tunerObj, &Tuner::noteReceived, this, &TunerFrame::onTunerNote);
  connect(&mTunerIndex, &TunerIndex::indexReceived, this,
          &TunerFrame::onTunerIndex);
  connect(&globalObj, &Global::masterTuneReceived, this,
          &TunerFrame::onMasterTune);
...
void TunerFrame::onMute(bool muted) { ui.muteDial->setValue(muted ? 1 : 0); }
