...
void GraphicEqualizerFrame::activate(QObject &stomp) {
  ...
  if (mpStomp != nullptr) {
    ...
    connect(mpStomp, &Stomp::duckingReceived, this,
            &GraphicEqualizerFrame::onDucking);
    connect(mpStomp, &Stomp::volumeReceived, this,
            &GraphicEqualizerFrame::onVolume);
    connect(mpStomp, &Stomp::graphicEQBand1Received, this,
            &GraphicEqualizerFrame::onBand1);
    connect(mpStomp, &Stomp::graphicEQBand2Received, this,
            &GraphicEqualizerFrame::onBand2);
    connect(mpStomp, &Stomp::graphicEQBand3Received, this,
            &GraphicEqualizerFrame::onBand3);
    connect(mpStomp, &Stomp::graphicEQBand4Received, this,
            &GraphicEqualizerFrame::onBand4);
    connect(mpStomp, &Stomp::graphicEQBand5Received, this,
            &GraphicEqualizerFrame::onBand5);
    connect(mpStomp, &Stomp::graphicEQBand6Received, this,
            &GraphicEqualizerFrame::onBand6);
    connect(mpStomp, &Stomp::graphicEQBand7Received, this,
            &GraphicEqualizerFrame::onBand7);
    connect(mpStomp, &Stomp::graphicEQBand8Received, this,
            &GraphicEqualizerFrame::onBand8);
    connect(mpStomp, &Stomp::lowCutReceived, this,
            &GraphicEqualizerFrame::onLowCut);
    connect(mpStomp, &Stomp::highCutReceived, this,
            &GraphicEqualizerFrame::onHighCut);
...
void GraphicEqualizerFrame::deactivate() {
  if (mpStomp != nullptr) {
    disconnect(mpStomp, &Stomp::mixReceived, this,
               &GraphicEqualizerFrame::onMix);
    disconnect(mpStomp, &Stomp::duckingReceived, this,
               &GraphicEqualizerFrame::onDucking);
    disconnect(mpStomp, &Stomp::volumeReceived, this,
               &GraphicEqualizerFrame::onVolume);
    disconnect(mpStomp, &Stomp::graphicEQBand1Received, this,
               &GraphicEqualizerFrame::onBand1);
    disconnect(mpStomp, &Stomp::graphicEQBand2Received, this,
               &GraphicEqualizerFrame::onBand2);
    disconnect(mpStomp, &Stomp::graphicEQBand3Received, this,
               &GraphicEqualizerFrame::onBand3);
    disconnect(mpStomp, &Stomp::graphicEQBand4Received, this,
               &GraphicEqualizerFrame::onBand4);
    disconnect(mpStomp, &Stomp::graphicEQBand5Received, this,
               &GraphicEqualizerFrame::onBand5);
    disconnect(mpStomp, &Stomp::graphicEQBand6Received, this,
               &GraphicEqualizerFrame::onBand6);
    disconnect(mpStomp, &Stomp::graphicEQBand7Received, this,
               &GraphicEqualizerFrame::onBand7);
    disconnect(mpStomp, &Stomp::graphicEQBand8Received, this,
               &GraphicEqualizerFrame::onBand8);
...
void GraphicEqualizerFrame::displayStompType(StompInstance stompInstance,
                                             FXType fxType) {
  ui.lcdDisplay->setStompFXType(stompInstance, fxType);
}

void GraphicEqualizerFrame::displayStompEnabled(StompInstance stompInstance,
                                                bool enabled) {
