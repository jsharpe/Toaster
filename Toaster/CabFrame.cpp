...
CabFrame::CabFrame(QWidget *parent) : QWidget(parent) { ui.setupUi(this); }
...
void CabFrame::onHighShift(double value) { ui.highShiftDial->setValue(value); }

void CabFrame::onLowShift(double value) { ui.lowShiftDial->setValue(value); }

void CabFrame::onCharacter(double value) { ui.characterDial->setValue(value); }

void CabFrame::onVolume(double value) { ui.volumeDial->setValue(value); }
