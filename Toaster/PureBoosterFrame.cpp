...
PureBoosterFrame::PureBoosterFrame(QWidget *parent) : QWidget(parent) {
  ui.setupUi(this);
}
...
void PureBoosterFrame::displayStompType(StompInstance stompInstance,
                                        FXType fxType) {
  ui.lcdDisplay->setStompFXType(stompInstance, fxType);
}

void PureBoosterFrame::displayStompEnabled(StompInstance stompInstance,
                                           bool enabled) {
