...
MetalDSFrame::MetalDSFrame(QWidget *parent) : QWidget(parent) {
  ui.setupUi(this);
...
void MetalDSFrame::displayStompType(StompInstance stompInstance,
                                    FXType fxType) {
  ui.lcdDisplay->setStompFXType(stompInstance, fxType);
}

void MetalDSFrame::displayStompEnabled(StompInstance stompInstance,
                                       bool enabled) {
