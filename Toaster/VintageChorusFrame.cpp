...
VintageChorusFrame::VintageChorusFrame(QWidget *parent) : QWidget(parent) {
  ui.setupUi(this);
...
void VintageChorusFrame::displayStompType(StompInstance stompInstance,
                                          FXType fxType) {
  ui.lcdDisplay->setStompFXType(stompInstance, fxType);
}

void VintageChorusFrame::displayStompEnabled(StompInstance stompInstance,
                                             bool enabled) {
