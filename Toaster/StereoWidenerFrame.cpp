...
StereoWidenerFrame::StereoWidenerFrame(QWidget *parent) : QWidget(parent) {
  ui.setupUi(this);
}
...
void StereoWidenerFrame::displayStompType(StompInstance stompInstance,
                                          FXType fxType) {
  ui.lcdDisplay->setStompFXType(stompInstance, fxType);
}

void StereoWidenerFrame::displayStompEnabled(StompInstance stompInstance,
                                             bool enabled) {
