...
LoopDistortionFrame::LoopDistortionFrame(QWidget *parent) : QWidget(parent) {
  ui.setupUi(this);
}
...
void LoopDistortionFrame::displayStompType(StompInstance stompInstance,
                                           FXType fxType) {
  ui.lcdDisplay->setStompFXType(stompInstance, fxType);
}

void LoopDistortionFrame::displayStompEnabled(StompInstance stompInstance,
                                              bool enabled) {
