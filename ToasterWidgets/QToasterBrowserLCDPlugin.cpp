...
void QToasterBrowserLCDPlugin::initialize(
...
bool QToasterBrowserLCDPlugin::isInitialized() const { return m_initialized; }
...
QString QToasterBrowserLCDPlugin::group() const { return QLatin1String(""); }

QIcon QToasterBrowserLCDPlugin::icon() const { return QIcon(); }

QString QToasterBrowserLCDPlugin::toolTip() const { return QLatin1String(""); }

QString QToasterBrowserLCDPlugin::whatsThis() const {
  return QLatin1String("");
}

bool QToasterBrowserLCDPlugin::isContainer() const { return false; }

QString QToasterBrowserLCDPlugin::domXml() const {
  return QLatin1String("<widget class=\"QToasterBrowserLCD\" "
                       "name=\"toasterBrowserLCD\">\n</widget>\n");
}
