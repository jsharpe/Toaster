...
QMultiColorLedPlugin::QMultiColorLedPlugin(QObject *parent) : QObject(parent) {
  m_initialized = false;
}

void QMultiColorLedPlugin::initialize(
...
bool QMultiColorLedPlugin::isInitialized() const { return m_initialized; }
...
QString QMultiColorLedPlugin::group() const { return QLatin1String(""); }

QIcon QMultiColorLedPlugin::icon() const { return QIcon(); }

QString QMultiColorLedPlugin::toolTip() const { return QLatin1String(""); }

QString QMultiColorLedPlugin::whatsThis() const { return QLatin1String(""); }

bool QMultiColorLedPlugin::isContainer() const { return false; }

QString QMultiColorLedPlugin::domXml() const {
  return QLatin1String(
      "<widget class=\"QMultiColorLed\" name=\"qMultiColorLed\">\n</widget>\n");
}
