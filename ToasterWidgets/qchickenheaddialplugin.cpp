...
void QChickenHeadDialPlugin::initialize(
...
bool QChickenHeadDialPlugin::isInitialized() const { return m_initialized; }
...
QString QChickenHeadDialPlugin::group() const { return QLatin1String(""); }

QIcon QChickenHeadDialPlugin::icon() const {
  return QIcon(":/resources/ChickeHeadDialIcon.png");
}

QString QChickenHeadDialPlugin::toolTip() const { return QLatin1String(""); }

QString QChickenHeadDialPlugin::whatsThis() const { return QLatin1String(""); }

bool QChickenHeadDialPlugin::isContainer() const { return false; }

QString QChickenHeadDialPlugin::domXml() const {
  return QLatin1String("<widget class=\"QChickenHeadDial\" "
                       "name=\"qChickenHeadDial\">\n</widget>\n");
}
