...
QToasterDialPlugin::QToasterDialPlugin(QObject *parent) : QObject(parent) {
  m_initialized = false;
}
...
bool QToasterDialPlugin::isInitialized() const { return m_initialized; }
...
QString QToasterDialPlugin::group() const { return QLatin1String(""); }

QIcon QToasterDialPlugin::icon() const {
  return QIcon(":/resources/DialIcon.png");
}

QString QToasterDialPlugin::toolTip() const { return QLatin1String(""); }

QString QToasterDialPlugin::whatsThis() const { return QLatin1String(""); }

bool QToasterDialPlugin::isContainer() const { return false; }

QString QToasterDialPlugin::domXml() const {
  return QLatin1String(
      "<widget class=\"QToasterDial\" name=\"qToasterDial\">\n</widget>\n");
}
