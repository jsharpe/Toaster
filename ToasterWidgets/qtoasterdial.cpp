...
QToasterDial::QToasterDial(QWidget *parent)
    : QWidget(parent), mCurrKnobFrameNo(0), mCurrLEDRingFrameNo(0),
      mKnobSize(Big), mLEDRingType(Uni), mMouseY(0), mMinValue(0),
      mMaxValue(16383), mStepWidth(1), mPrecision(0), mCurrValue(0),
      mCurrValueText("<0.0>"), mUnit(""), mIsActive(true),
...
void QToasterDial::setUnit(QString unit) { mUnit = unit; }
