...
#define BROWSER_VIEW_STYLESHEETS                                               \
  "QComboBox#browserViewComboBox\
{\
%1; \
...
QToasterBrowserLCD::QToasterBrowserLCD(QWidget *parent)
    : QToasterLCD(parent), ui(new Ui::QToasterBrowserLCD) {
  ui->setupUi(this);
  setFonts();
  createSkin();
...
void QToasterBrowserLCD::setColor(QToasterLCD::Color color) {
  ...
  ui->browserViewComboBox->setStyleSheet(
      QString(BROWSER_VIEW_STYLESHEETS).arg(colorStyleSheet));
  /*
...
void QToasterBrowserLCD::setStompFXType(StompInstance stompInstance,
                                        FXType fxType) {
...
void QToasterBrowserLCD::setStompEnabled(StompInstance stompInstance,
                                         bool enabled) {
  switch (stompInstance) {
  case StompA:
