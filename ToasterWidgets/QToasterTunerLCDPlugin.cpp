...
void QToasterTunerLCDPlugin::initialize(
...
bool QToasterTunerLCDPlugin::isInitialized() const { return m_initialized; }
...
QString QToasterTunerLCDPlugin::group() const { return QLatin1String(""); }

QIcon QToasterTunerLCDPlugin::icon() const { return QIcon(); }

QString QToasterTunerLCDPlugin::toolTip() const { return QLatin1String(""); }

QString QToasterTunerLCDPlugin::whatsThis() const { return QLatin1String(""); }

bool QToasterTunerLCDPlugin::isContainer() const { return false; }

QString QToasterTunerLCDPlugin::domXml() const {
  return QLatin1String("<widget class=\"QToasterTunerLCD\" "
                       "name=\"toasterTunerLCD\">\n</widget>\n");
}
