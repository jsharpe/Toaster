...
QMap<FXType, QString> QToasterLCD::sFXType2ShortNameMap = {
    {None, "-"},
    {WahWah, "WWAH"},
    {WahLowPass, "WLPF"},
    {WahHighPass, "WHPF"},
...
QMap<QToasterLCD::Color, QString> QToasterLCD::sColor2StyleSheetsMap = {
    {Standard, COLOR_STANDARD}, {Orange, COLOR_ORANGE}, {Red, COLOR_RED},
    {Yellow, COLOR_YELLOW},     {Cyan, COLOR_CYAN},     {Blue, COLOR_BLUE},
    {Purple, COLOR_PURPLE},     {White, COLOR_WHITE},   {Green, COLOR_GREEN}};

QToasterLCD::QToasterLCD(QWidget *parent)
    : QWidget(parent), mColor(Standard), mMaxPage(Page2), mCurrentPage(Page1),
...
void QToasterLCD::setMaxPage(Page page) { mMaxPage = page; }
