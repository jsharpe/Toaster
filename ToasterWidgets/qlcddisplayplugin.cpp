...
QLCDDisplayPlugin::QLCDDisplayPlugin(QObject *parent) : QObject(parent) {
  m_initialized = false;
}
...
bool QLCDDisplayPlugin::isInitialized() const { return m_initialized; }

QWidget *QLCDDisplayPlugin::createWidget(QWidget *parent) {
  return new QLCDDisplay(parent);
}

QString QLCDDisplayPlugin::name() const { return QLatin1String("QLCDDisplay"); }

QString QLCDDisplayPlugin::group() const { return QLatin1String(""); }

QIcon QLCDDisplayPlugin::icon() const { return QIcon(); }

QString QLCDDisplayPlugin::toolTip() const { return QLatin1String(""); }

QString QLCDDisplayPlugin::whatsThis() const { return QLatin1String(""); }

bool QLCDDisplayPlugin::isContainer() const { return false; }

QString QLCDDisplayPlugin::domXml() const {
  return QLatin1String(
      "<widget class=\"QLCDDisplay\" name=\"qLCDDisplay\">\n</widget>\n");
}
