...
QSmallKnobPlugin::QSmallKnobPlugin(QObject *parent) : QObject(parent) {
  m_initialized = false;
}
...
bool QSmallKnobPlugin::isInitialized() const { return m_initialized; }

QWidget *QSmallKnobPlugin::createWidget(QWidget *parent) {
  return new QSmallKnob(parent);
}

QString QSmallKnobPlugin::name() const { return QLatin1String("QSmallKnob"); }

QString QSmallKnobPlugin::group() const { return QLatin1String(""); }

QIcon QSmallKnobPlugin::icon() const { return QIcon(); }

QString QSmallKnobPlugin::toolTip() const { return QLatin1String(""); }

QString QSmallKnobPlugin::whatsThis() const { return QLatin1String(""); }

bool QSmallKnobPlugin::isContainer() const { return false; }

QString QSmallKnobPlugin::domXml() const {
  return QLatin1String(
      "<widget class=\"QSmallKnob\" name=\"qSmallKnob\">\n</widget>\n");
}
