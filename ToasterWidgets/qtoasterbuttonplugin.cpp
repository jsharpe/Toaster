...
QToasterButtonPlugin::QToasterButtonPlugin(QObject *parent) : QObject(parent) {
  m_initialized = false;
}

void QToasterButtonPlugin::initialize(
...
bool QToasterButtonPlugin::isInitialized() const { return m_initialized; }
...
QString QToasterButtonPlugin::group() const { return QLatin1String(""); }

QIcon QToasterButtonPlugin::icon() const {
  return QIcon(":/resources/ButtonIcon.png");
}

QString QToasterButtonPlugin::toolTip() const { return QLatin1String(""); }

QString QToasterButtonPlugin::whatsThis() const { return QLatin1String(""); }

bool QToasterButtonPlugin::isContainer() const { return false; }

QString QToasterButtonPlugin::domXml() const {
  return QLatin1String(
      "<widget class=\"QToasterButton\" name=\"qToasterButton\">\n</widget>\n");
}
