...
void QToasterStompEditLCDPlugin::initialize(
...
bool QToasterStompEditLCDPlugin::isInitialized() const { return m_initialized; }
...
QString QToasterStompEditLCDPlugin::group() const { return QLatin1String(""); }

QIcon QToasterStompEditLCDPlugin::icon() const { return QIcon(); }
...
bool QToasterStompEditLCDPlugin::isContainer() const { return false; }

QString QToasterStompEditLCDPlugin::domXml() const {
  return QLatin1String("<widget class=\"QToasterStompEditLCD\" "
                       "name=\"toasterStompEditLCD\">\n</widget>\n");
}
