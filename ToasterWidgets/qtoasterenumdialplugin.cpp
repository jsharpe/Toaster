...
void QToasterEnumDialPlugin::initialize(
...
bool QToasterEnumDialPlugin::isInitialized() const { return m_initialized; }
...
QString QToasterEnumDialPlugin::group() const { return QLatin1String(""); }

QIcon QToasterEnumDialPlugin::icon() const {
  return QIcon(":/resources/DialIcon.png");
}

QString QToasterEnumDialPlugin::toolTip() const { return QLatin1String(""); }

QString QToasterEnumDialPlugin::whatsThis() const { return QLatin1String(""); }

bool QToasterEnumDialPlugin::isContainer() const { return false; }

QString QToasterEnumDialPlugin::domXml() const {
  return QLatin1String("<widget class=\"QToasterEnumDial\" "
                       "name=\"qToasterEnumDial\">\n</widget>\n");
}
